...
public interface StreamingChatModel {
     ...
     * @param handler     a {@link dev.langchain4j.model.chat.response.StreamingChatResponseHandler} that will handle streaming response from the LLM
     */
    default void chat(ChatRequest chatRequest, dev.langchain4j.model.chat.response.StreamingChatResponseHandler handler) {
        ...
        dev.langchain4j.model.chat.response.StreamingChatResponseHandler observingHandler = new dev.langchain4j.model.chat.response.StreamingChatResponseHandler() {
    ...
    default void doChat(ChatRequest chatRequest, dev.langchain4j.model.chat.response.StreamingChatResponseHandler handler) {
    ...
    default void chat(String userMessage, dev.langchain4j.model.chat.response.StreamingChatResponseHandler handler) {
